...
Table~\ref{tbl:uitvoering} shows the execution times for the different problems.
...
Adding additional examples, however, only increases the execution time by a constant factor.
